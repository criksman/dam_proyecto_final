...
class ListEventosFuturos extends StatefulWidget {
  //const ListEventos({super.key});

  @override
  State<ListEventosFuturos> createState() => _ListEventosFuturosState();
}

class _ListEventosFuturosState extends State<ListEventosFuturos> {
  @override
  Widget build(BuildContext context) {
    return Column(
      children: [
        Expanded(
          child: StreamBuilder(
            stream: FirestoreService().eventoDespuesDeFechaActual(),

                ...
                Expanded(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () {
                        print('Contiene Imagen: ${!imageUrl.isEmpty}');
                        print('Contiene Hora: ${!selectedTime.isEmpty}');

                        if (formKey.currentState!.validate() && !imageUrl.isEmpty  && !selectedTime.isEmpty){
                          ...
                          FirestoreService().agregarEvento(nombre, tipo, desc, combinedDateTime, lugar, imageUrl);

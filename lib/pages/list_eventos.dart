...
class _ListEventosState extends State<ListEventos> {
                      ...
                      startActionPane:
                        ...
                        SlidableAction(
                          ...
                          onPressed: (context) {
                            ...
                            infoEvento(context, nombre, lugar, tipo, descripcion, fecha, me_gusta, foto);
                          },
                        ),
                      ]),
                      child: ListTile(
  ...
  void infoEvento(BuildContext context, nombre, lugar, tipo, descripcion, fecha, me_gusta, foto) {
        ...
        return SizedBox(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Container(
                  child: Text('Detalles del evento', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: Color(0xFF051E34))),
                ),
                Container(
